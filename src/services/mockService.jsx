...
import deliveriesData from '../data/mockDeliveries';
import ordersTableData from '../data/mockOrdersTable'; // <-- Add this line
...
mock.onGet('/api/deliveries').reply(200, deliveriesData);
mock.onGet('/api/orders-table').reply(200, ordersTableData); // <-- Add this line
